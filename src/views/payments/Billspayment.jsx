  ...
  return (
    <div className="payments">
      ...
      <div className="wrapper">
        <main>
          <header>
            <h2>Tap any of the options to make bill payments</h2>
          </header>

          <ul>
            <Link to="/payments/billpayments/airtime">
              <li>
            ...
            <Link to="/payments/billpayments/data">
              <li>
                <div className="payment-type">
                  <svg
                    width="30"
            ...
            <Link to="/payments/billpayments/electricity">
              <li>
                <div className="payment-type">
                  <svg
                    width="30"
            ...
            <Link to="/payments/billpayments/others">
              <li>
                <div className="payment-type">
                  <svg
                    width="30"
                  ...
                  <span>
                    <h3>Others</h3>
                    <p>TV, Flight, Travel and Hotel...</p>
                  </span>
                </div>
                <svg
                  width="8"
